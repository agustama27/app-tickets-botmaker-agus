-- Supabase Schema for App Tickets
...
-- Nota: RLS está habilitado pero sin políticas, lo que significa que solo el service_role puede acceder
-- El backend usa service_role que tiene acceso completo
-- Si necesitas RLS con políticas específicas, puedes crearlas después basadas en roles de usuario

-- Por ahora, deshabilitamos RLS para permitir acceso completo desde el backend
-- Si quieres habilitar RLS más adelante, descomenta las siguientes líneas y crea políticas específicas

-- ALTER TABLE areas ENABLE ROW LEVEL SECURITY;
-- ALTER TABLE teams ENABLE ROW LEVEL SECURITY;
-- ALTER TABLE user_app ENABLE ROW LEVEL SECURITY;
